...
dotypes:
	g++ opengl/dibuja.cpp opengl/gl2ps.c -lglut -lGL -lGLU -lcurl -lm -o dibuja && ./dibuja

dthrackles:
	g++ opengl/dibuja_thrackles.cpp opengl/gl2ps.c -lglut -lGL -lGLU -lcurl -lm -o dibuja && ./dibuja
