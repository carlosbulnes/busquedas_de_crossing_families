...
int son_intersecting_familiy(Segmento s1, Segmento s2, Segmento s3, Segmento s4, Segmento s5, Segmento s6, Segmento s7, Segmento s8){
	int valor = 1;
...
int main(int argc, char *argv[]){
	...
	strcpy(order_type, "intersecting_families/logK2-");
								...
								for(i7 = i6+1; i7 < nsegmentos; i7++){
									for(i8 = i7+1; i8 < nsegmentos; i8++){
										...
										if(son_intersecting_familiy(segmentos[i1], segmentos[i2], segmentos[i3], segmentos[i4], 
											segmentos[i5], segmentos[i6], segmentos[i7], segmentos[i8])){
											/*fprintf(log, "%s, %s, %s, %s, %s, %s, %s, %s\n", 
												segmentos[i1].etiqueta, segmentos[i2].etiqueta, segmentos[i3].etiqueta, segmentos[i4].etiqueta, 
												segmentos[i5].etiqueta, segmentos[i6].etiqueta, segmentos[i7].etiqueta, segmentos[i8].etiqueta);*/
											cont++;
										}
